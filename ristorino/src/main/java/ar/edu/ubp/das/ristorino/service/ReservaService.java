...
public class ReservaService {
    ...
    public ResponseBean registrarReserva(ReservaBean reserva) {
        ...
        System.out.println("reserva antes del restaurante "+json);
        ...
        if (body.getEstado() == null) {
            ...
            resp.setMessage(body.getMensaje());
            return resp;
        }
        ...
        System.out.println(body.getMensaje()+" "+body.getCodReserva());
        ...
        resp.setMessage(body.getCodReserva());
        return resp;
    }
